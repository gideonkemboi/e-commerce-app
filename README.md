...
This app is configured to deploy to GitHub Pages. The deployment workflow is defined in [`.github/workflows/deploy.yml`](https://github.com/gideonkemboi/e-commerce-app/blob/main/.github/workflows/deploy.yml).

### Live Website

Check out the live version of the app here: [Exquisite E-Commerce App](https://gideonkemboi.github.io/e-commerce-app/)
